...
export function toast(toast: Omit<ToastProps, 'id' | 'topic'>, topic?: string, timeOut?: number) {
...
function Toast({ title, description, button, id, topic, ...props }: ToastProps) {
    return (
        <div className="flex rounded-lg bg-transparent shadow-lg ring-1 ring-black/5 dark:ring-white/5 w-full md:max-w-sm items-center p-4">
